...
- File name:  NTESNetChatViewController.h
- Description: 云信通话的基础页面
- Function List:
*/
...
@property(nonatomic, copy) void (^nimMessageBlock)(ChatModel*model,BOOL send);
...
-(instancetype)initWithNIMNetCallMediaType:(NIMNetCallMediaType)nIMNetCallMediaType;
//主叫方开始界面回调
- (void)startByCaller;
//被叫方开始界面回调
- (void)startByCallee;
