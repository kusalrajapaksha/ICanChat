//
//  C2COrderCompletedViewController.m
//  ICan
//
...
@interface C2COrderCompletedViewController ()
@property (nonatomic, strong) NSArray *titleItems;
@end

@implementation C2COrderCompletedViewController
...
-(instancetype)init{
    if (self=[super init]) {
         ...
         */
        self.titleItems =@[@"C2COrderStateAll".icanlocalized,@"C2COrderStateCompleted".icanlocalized,@"C2COrderStateCancelled".icanlocalized];
...
- (UIViewController *)pageController:(WMPageController *)pageController viewControllerAtIndex:(NSInteger)index {
    ...
    switch (index) {
        case 0:
            vc.orderStatus = @[@"Completed",@"Cancelled"];
            break;
        
        case 1:
            vc.orderStatus = @[@"Completed"];
            break;
        case 2:
            vc.orderStatus = @[@"Cancelled"];
            break;
