...
- File name:  RechargeRecordListViewController.m
- Description:
- Function List:
*/
...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.title=NSLocalizedString(@"RechargeRecord", 充值记录);
...
-(CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    return kHeightRechargeRecordListTableViewCell;
}
...
-(void)fetchListRequest{
    ...
    request.flowType=@"BalanceRecharge";
    ...
    @weakify(self);
    [[NetworkRequestManager shareManager]startRequest:request responseClass:[FlowsListInfo class] contentClass:[BillInfo class] success:^(FlowsListInfo* response) {
        @strongify(self);
