...
@interface C2CBaseTableListViewController ()
@property (nonatomic,strong)MJRefreshBackNormalFooter*footer;
@end

@implementation C2CBaseTableListViewController
...
-(void)fetchListRequest{
    ...
    @weakify(self);
    [[C2CNetRequestManager shareManager]startRequest:self.listRequest responseClass:[self.listClass class] contentClass:[self.listClass class] success:^(C2CListInfo* response) {
        @strongify(self);
