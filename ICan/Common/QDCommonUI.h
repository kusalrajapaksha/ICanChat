...
#define UIColorGray1 UIColorMake(32, 27, 23)
...
//文字深色
#define UIColorGray10 UIColorMake(51, 51, 51)
//文字浅色
#define UIColorGray11 UIColorMake(102, 102, 102)
//文字最浅色
#define UIColorGray12 UIColorMake(153, 153, 153)
//分割线颜色
#define UIColorGray13 UIColorMake(227, 228, 229)


#define UIColorDarkGray1 UIColorMake(50, 50, 50)
#define UIColorDarkGray2 UIColorMake(198, 200, 204)
#define UIColorDarkGray3 UIColorMake(32, 27, 23)
...
#define UIColorTheme6 UIColorMake(8, 63, 190) // 默认
