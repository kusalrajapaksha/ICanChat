...
- (void)addRefreshFooterWithClosure:(PSRefreshClosure)closure {
    if (!self.footer && !self.gifFooter) {
        ...
        [self.footer setTitle:@"查看更多" forState:PSRefreshStatePullCanRefresh];
        [self.footer setTitle:@"查看更多" forState:PSRefreshStateReleaseCanRefresh];
        [self.footer setTitle:@"查看更多" forState:PSRefreshStateRefreshing];
        [self.footer setTitle:@"查看更多" forState:PSRefreshStateNoMoreData];
