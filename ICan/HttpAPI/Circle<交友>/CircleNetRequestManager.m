...
#import "CircleNetRequestManager.h"
#import "AFNetworking.h"
@interface CircleNetRequestManager ()
@property (nonatomic,strong) AFHTTPSessionManager * manager;
@end

@implementation CircleNetRequestManager
+ (instancetype)shareManager {
    static CircleNetRequestManager *api;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        api = [[CircleNetRequestManager alloc] init];
...
-(void)startRequest:(CircleBaseRequest *)request
    ...
    [req setValue:CircleUserInfoManager.shared.token forHTTPHeaderField:@"token"];
...
-(void)_operateSuccessWithNSURLResponse:(NSURLResponse*)response error:(NSError *)error responseObject:(id)responseObject responseClass:(Class)responseClass  contentClass:(Class)contentClass success:(SuccessCallback)success failure:(FailureCallback)failure baserRequest:(CircleBaseRequest*)request nSMutableURLRequest:(NSMutableURLRequest*)nsMutableURLRequest {
...
-(void)_operateLogRequestWithNSHTTPURLResponse:(NSHTTPURLResponse*)response error:(NSError *)error responseObject:(id)responseObject baserRequest:(CircleBaseRequest*)request responseClass:(Class)responseClass contentClass:(Class)contentClass  success:(SuccessCallback)success failure:(FailureCallback)failure nSMutableURLRequest:(NSMutableURLRequest*)nsMutableURLRequest{
...
-(void)_logHttpResultWithRequest:(CircleBaseRequest*)request responseObject:(id)responseObject responseClass:(Class)responseClass contentClass:(Class)contentClass httpResponse:(NSHTTPURLResponse*)response httpHeadDic:(NSDictionary*)headDict{
    NSString * requestMethod;
    switch (request.requestMethod) {
        case RequestMethod_Get:
            requestMethod=@"GET";
...
-(void)_logCurlStringWithDict:(NSDictionary*)headDict request:(CircleBaseRequest*)request{
